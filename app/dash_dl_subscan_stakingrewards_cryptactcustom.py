...
def update_active_cell_info(n_clicks):
    if n_clicks:
        ...
        webbrowser.open('https://github.com/7rikazhexde/Dash-App-Collection/blob/main/Subscan_Download_StakingRewardsHistory/dlSubscanStakingRewardsHistoryDash/README.md')
        return no_update
    raise PreventUpdate
