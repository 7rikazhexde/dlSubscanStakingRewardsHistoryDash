...
# https://manta.subscan.io/reward?address=[address]&role=account

url = "https://manta.api.subscan.io/api/scan/account/reward_slash"
...
for i in range(list_num):
    ...
    rounded_value = value.quantize(Decimal("1e-16"), rounding=ROUND_HALF_UP)
    print(rounded_value)
